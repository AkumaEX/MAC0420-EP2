...
class Grid(Actor):
    ...
    def __init__(self, scene, **kwargs):
        ...
        super(Grid, self).__init__(
            scene, mode=Actor.RenderMode.LineStrip, **kwargs)
        ...
        self._material = kwargs.get(
            "material", Material(diffuse=QVector3D(0.5, 0.5, 0.5)))
        ...
        self.setNoLightWireframeShader(
            self.shaderCollection.uniformMaterialShader())
    ...
    def generateGeometry(self):
        ...
        self._vertices = np.concatenate(
            (vertical.flatten(), horizontal.flatten()))
    ...
    def render(self):
        """Render grid"""
        GL.glMultiDrawArrays(self._render_mode, self._start,
                             self._lengths, self._resx+self._resy)
